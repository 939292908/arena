...
methods.getWebApiErrorCode = function (code) {
    ...
    return obj[code] || I18n.$t('20140')/* '系统繁忙，请稍后重试' */ + `(${code})`;
};
...
// 活动错误码
methods.getArenaErrorCode = function(code, value) {
    const obj = {
        0: "正常", // 正常
        "-1": "服务启动中", // 服务启动中
        "-2": "接口口令错误", // 接口口令错误
        ...
        "-16": "活动已结束", // 活动已结束
        "-17": "已达到人数上限", // 已达到人数上限
        "-21": "指定排行榜不存在", // 指定排行榜不存在
        "-1012": "资金不足" // (用户或系统账号)资金不足
    };
    return obj[code] || I18n.$t('20140')/* 系统繁忙，请稍后重试 */; // 未知错误
};
